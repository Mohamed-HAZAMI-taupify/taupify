...
import { addEverfitContact } from "../../../../../../../redux/actions/everfit/ContactActions";

const AddEverfitContactModalContent = (props) => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    BPJEPSAF: "BPJEPS AF OPTION HALTÉROPHILIE MUSCULATION",
    message: "",
    subscribe: true,
    codepostal: "",
  });

  const { firstname, lastname, email, phone, BPJEPSAF, message, codepostal } =
    formData;
      ...
      <div className="input-modal-inputs-container">
        ...
        <div className="input-modal-element">
          ...
          <TextField
            ...
            onChange={(e) => onChange(e)}
          />
          <label className="alert">{alerts.lastname && alerts.lastname}</label>
        </div>
      </div>
      <div className="input-modal-inputs-container">
        <div className="input-modal-element">
